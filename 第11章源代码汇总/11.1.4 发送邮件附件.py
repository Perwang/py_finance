# =============================================================================
# 11.1.4 发送邮件附件 by 华能信托-王宇韬 代码更新：www.huaxiaozhi.com 资料下载区
# =============================================================================
...
att1 = MIMEText(open('三行情书.docx', 'rb').read(), 'base64', 'utf-8')
att1["Content-Type"] = 'application/octet-stream'
# 下面的filename是在邮件中显示的名字及后缀名
att1.add_header('Content-Disposition', 'attachment', filename=('utf-8', '', '三行情书.docx'))  # 2020更新
msg.attach(att1)
